      ...
      <div className="w-full max-w-md p-8 space-y-6">
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 space-y-6 border border-slate-700">
          <div className="space-y-2">
            ...
            <p className="text-gray-400 text-sm">Start managing your expenses with AI</p>
          </div>

          {error && (
            <div className="bg-red-500/10 border border-red-500/50 rounded-lg p-3 text-red-400 text-sm" data-testid="signup-error-message">
              {error}
            </div>
          )}
